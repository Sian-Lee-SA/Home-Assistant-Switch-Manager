...
mqtt_sub_topics | `bool`       | -        | Along with the base topic, subtopics will be listened to aswell and passed in for condition checking etc. Default is false
