...
`;let Ee=class extends nt{constructor(){super(...arguments),this._data=[],this._columns=function(t,e){void 0===e&&(e=lt);var i=null;function s(){for(var s=[],o=0;o<arguments.length;o++)s[o]=arguments[o];if(i&&i.lastThis===this&&e(s,i.lastArgs))return i.lastResult;var n=t.apply(this,s);return i={lastResult:n,lastArgs:s,lastThis:this},n}return s.clear=function(){i=null},s}((()=>({image:{title:"",sortable:!1,filterable:!1,grows:!1,width:"90px",template:(t,e)=>e.switch.valid_blueprint?e.switch.blueprint.has_image?j`<img style="max-width: 100%;max-height: 48px;display: block;margin:0 auto;" src="${ft(`${t}.png`)}" />`:j`<ha-svg-icon style="fill: var(--primary-color); margin: 0 auto;display:block;height: 85%;
                        width: 85%;" .path=${dt}></ha-svg-icon>`:""},name:{title:"Name",main:!0,direction:"asc",sortable:!0,filterable:!0,grows:!0,template:(t,e)=>e.error?j`<span style="color: red;">${t} (${e.error})</span>`:t},enabled:{title:"",width:"10%",template:t=>t?"":j`
                        <ha-chip>
                            Disabled
                        </ha-chip>`},service:{title:"Service",sortable:!0,filterable:!0,width:"15%"},type:{title:"Type",sortable:!0,filterable:!0,grows:!1,width:"15%"},actions:{title:"",width:this.narrow?void 0:"10%",type:"overflow-menu",template:(t,e)=>j`
                        ...
                        </ha-icon-overflow-menu>`}})))}render(){return j`
            <ha-app-layout>
        ...
        `}_tab_changed(t){let e=new CustomEvent("changed",{detail:{index:t.detail.item.parentNode.indexOf(t.detail.item)}});this.dispatchEvent(e)}};t([s()],Me.prototype,"hass",void 0),t([s()],Me.prototype,"blueprint_actions",void 0),t([s()],Me.prototype,"config_actions",void 0),t([s({reflect:!0})],Me.prototype,"index",void 0),Me=t([e("switch-manager-button-actions")],Me);class Pe extends nt{constructor(){super(...arguments),this.disabled=!1,this.sequence=[],this.button_index=0,this.action_index=0,this._dirty=!1,this._block_save=!1}render(){var t,e,i,s,o,n,r,a,l,h,d,c,p,u,v,g,m;return this.config?j`
            <ha-app-layout>
                <app-header slot="header" fixed>
                    <app-toolbar>
                        <ha-menu-button
                            ...
                            <ha-button-menu corner="BOTTOM_START" slot="toolbar-icon">
                                ...
                                <mwc-list-item
                                    ...
                                    @click=${this._toggleEnabled}>
                                        ...
                                        <ha-svg-icon
                                            slot="graphic"
                                            .path=${(null===(s=this.config)||void 0===s?void 0:s.enabled)?pt:ct}>
                                        </ha-svg-icon>
                                </mwc-list-item>
            ...
            <hui-view>
                <hui-panel-view>
                    ${(null===(o=this.config)||void 0===o?void 0:o.valid_blueprint)?j`
                    ...
                    <span id="identifier">
                        ...
                        ${"mqtt"!=this.blueprint.event_type||this.blueprint.mqtt_topic_format?j`
                        <ha-icon-button
                        ...
                        </ha-icon-button>`:j`${this.blueprint.mqtt_topic_format?j`<ha-alert alert-type="info">Format: ${this.blueprint.mqtt_topic_format}</ha-alert>`:""}`}
                        ${this._subscribed?j`
                    ...
                    <div id="switch-image">
                    ${this.blueprint&&!(null===(h=this.blueprint)||void 0===h?void 0:h.has_image)?j`<ha-svg-icon .path=${dt}></ha-svg-icon>`:j`<svg id="switch-svg"></svg>`}
                    </div>

                    ${(null===(d=this.config)||void 0===d?void 0:d.valid_blueprint)?j`
                    ...
                    <ha-card outlined>
                        <div class="card-content">
                            ...
                            ${(null===(u=this.config)||void 0===u?void 0:u.valid_blueprint)?j`
                    ...
                    ${(null===(m=this.config)||void 0===m?void 0:m.valid_blueprint)?j`
                    <div class="fab-container">
                        <ha-fab
                            slot="fab"
                            .label=${"Save"}
          ...
          `:j``}static get styles(){return[Ae,Ce,p`
            @keyframes pulse {
                from {
                    opacity: 1;
                }
            ...
            <ha-dialog
                ...
                .heading=${j`${this._params.warning?j`<ha-svg-icon
        ...
        `:j``}static get styles(){return[xe,Se,p`
        ...
        `]}_itemClicked(t){bt(mt(`new/${t}`)),this.closeDialog()}connectedCallback(){super.connectedCallback(),this._updateBlueprints()}_updateBlueprints(){this.hass.callWS({type:_t("blueprints")}).then((t=>{this.blueprints=t.blueprints})).catch((t=>yt(this,{message:t.message})))}_listBlueprints(){if(!this.blueprints)return;let t={};for(let e of Object.values(this.blueprints))t[e.service]||(t[e.service]=[]),t[e.service].push(e);let e=[];for(let i in t){e.push(j`<h2>${i}</h2>`);for(let s of t[i])e.push(j`
                <mwc-list-item @click=${()=>this._itemClicked(s.id)} data-item-id="${s.id}">
                        <div class="row">
                            <div class="image">
                                ${s.has_image?j`<img src="${ft(`${s.id}.png`)}" />`:j`<ha-svg-icon style="fill: var(--primary-color);" .path=${dt}></ha-svg-icon>`}
                            </div>
            ...
            <ha-dialog
                ...
                @closed=${this.closeDialog}
                .heading="${$t("Rename")}">
                ${this._error?j`<ha-alert alert-type="error">Missing Name</ha-alert>`:""}
        ...
        `:j``}static get styles(){return[Ae,xe,p`
            ha-textfield,
            ha-textarea {
              display: block;
            }
          ...
          `]}_valueChanged(t){t.stopPropagation();const e=t.target;this._newName=e.value}_save(){this._newName?(this._params.update(Object.assign(Object.assign({},this._params.config),{name:this._newName})),this.closeDialog()):this._error="Name is required"}};t([s({attribute:!1})],De.prototype,"hass",void 0),t([o()],De.prototype,"_opened",void 0),t([o()],De.prototype,"_error",void 0),De=t([e("switch-manager-dialog-rename-switch")],De);var qe=Object.freeze({__proto__:null});
