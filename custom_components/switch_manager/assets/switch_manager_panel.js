...
`;let Ht=class extends rt{constructor(){super(...arguments),this._data=[],this._columns=function(t,e){void 0===e&&(e=xt);var i=null;function o(){for(var o=[],s=0;s<arguments.length;s++)o[s]=arguments[s];if(i&&i.lastThis===this&&e(o,i.lastArgs))return i.lastResult;var n=t.apply(this,o);return i={lastResult:n,lastArgs:o,lastThis:this},n}return o.clear=function(){i=null},o}((()=>({image:{title:"",sortable:!1,filterable:!1,grows:!1,width:"90px",template:(t,e)=>e.switch.valid_blueprint?e.switch.blueprint.has_image?z`<img style="max-width: 100%;max-height: 48px;display: block;margin:0 auto;" src="${mt(`${t}.png`)}" />`:z`<ha-svg-icon style="fill: var(--primary-color); margin: 0 auto;display:block;height: 85%;
        ...
        `;var t,e}static get styles(){return[Ct,kt,At,p`
            ha-data-table {
            }
            hui-view {
                display: block;
        ...
        `]}connectedCallback(){super.connectedCallback(),this._populateSwitches()}_populateSwitches(){const t=[];this.hass.callWS({type:ft("configs")}).then((e=>{Object.values(e.configs).forEach((e=>{let i;i=e.valid_blueprint?e.blueprint:{id:e.blueprint},t.push({switch:e,image:i.id,switch_id:e.id,error:e._error,enabled:e.enabled,name:e.name,service:i.service,type:i.name,actions:e.id})})),this._data=t}))}_rowClicked(t){_t(gt(`edit/${t.detail.id}`))}async _toggleEnabled(t,e){this.hass.callWS({type:ft("config/enabled"),enabled:!e,config_id:t}).then((t=>{this._populateSwitches(),yt(this,{message:"Switch "+(t.enabled?"Enabled":"Disabled")})})).catch((t=>yt(this,{message:t.message})))}async _deleteConfirm(t){wt(this,{title:"Delete switch?",text:`${t.name} will be permanently deleted.`,confirmText:"Delete",dismissText:"Cancel",confirm:()=>this._delete(t.switch_id),confirmation:!0,destructive:!0})}async _delete(t){this.hass.callWS({type:ft("config/delete"),config_id:t.toString()}).then((t=>{this._populateSwitches(),yt(this,{message:"Switch Deleted"})})).catch((t=>yt(this,{message:t.message})))}_showBlueprintDialog(){ut(this,"show-dialog",{dialogTag:"switch-manager-dialog-blueprint-selector",dialogImport:()=>Promise.resolve().then((function(){return Rt})),dialogParams:{}})}};t([o()],Ht.prototype,"hass",void 0),t([o()],Ht.prototype,"narrow",void 0),t([o()],Ht.prototype,"panel",void 0),t([o()],Ht.prototype,"route",void 0),t([s()],Ht.prototype,"_data",void 0),Ht=t([e("switch-manager-index")],Ht);const Mt=1;class Nt{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Lt=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends Nt{constructor(t){var e;if(super(t),t.type!==Mt||"class"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter((e=>t[e])).join(" ")+" "}update(t,[e]){var i,o;if(void 0===this.nt){this.nt=new Set,void 0!==t.strings&&(this.st=new Set(t.strings.join(" ").split(/\s/).filter((t=>""!==t))));for(const t in e)e[t]&&!(null===(i=this.st)||void 0===i?void 0:i.has(t))&&this.nt.add(t);return this.render(e)}const s=t.element.classList;this.nt.forEach((t=>{t in e||(s.remove(t),this.nt.delete(t))}));for(const t in e){const i=!!e[t];i===this.nt.has(t)||(null===(o=this.st)||void 0===o?void 0:o.has(t))||(i?(s.add(t),this.nt.add(t)):(s.remove(t),this.nt.delete(t)))}return j}});let Pt=class extends rt{constructor(){super(...arguments),this.index=0}render(){return this.blueprint_actions&&1!=this.blueprint_actions.length?z`
        ...
        `}_tab_changed(t){let e=new CustomEvent("changed",{detail:{index:t.detail.item.parentNode.indexOf(t.detail.item)}});this.dispatchEvent(e)}};t([o()],Pt.prototype,"hass",void 0),t([o()],Pt.prototype,"blueprint_actions",void 0),t([o()],Pt.prototype,"config_actions",void 0),t([o({reflect:!0})],Pt.prototype,"index",void 0),Pt=t([e("switch-manager-button-actions")],Pt);let Tt=class extends rt{constructor(){super(...arguments),this.disabled=!1,this.sequence=[],this.button_index=0,this.action_index=0,this._dirty=!1,this._block_save=!1}render(){var t,e,i,o,s,n,r,a,l,h,d,c,p,u,v,g,m;return this.config?z`
            <ha-app-layout>
                <app-header slot="header" fixed>
                    <app-toolbar>
                        <ha-menu-button
                        ...
                        <div>
                            <ha-button-menu corner="BOTTOM_START" slot="toolbar-icon">
                                ...
                                <mwc-list-item
                                    ...
                                    class=${Lt({warning:Boolean(!this.is_new)})}
                                    graphic="icon"
                ...
                <hui-panel-view>
                    ...
                    <div class="fab-container">
                        <ha-fab
                            ...
                            collapse
                            @click=${this._save}
                            class=${Lt({dirty:this._dirty,blocked:this._block_save})}>
          ...
          `:z``}static get styles(){return[Ct,At,p`
            @keyframes pulse {
                from {
                    opacity: 1;
                }
            ...
            <ha-dialog
                ...
                <mwc-button
                    ...
                    slot="primaryAction"
                    class=${Lt({destructive:this._params.destructive||!1})}>
        ...
        `}};t([o({attribute:!1})],Ot.prototype,"hass",void 0),t([s()],Ot.prototype,"_params",void 0),Ot=t([e("switch-manager-dialog-confirm")],Ot);var Ut=Object.freeze({__proto__:null});let Dt=class extends rt{constructor(){super(...arguments),this._opened=!1}showDialog(){this._opened=!0}closeDialog(){this._opened&&ut(this,"dialog-closed",{dialog:this.localName}),this._opened=!1}render(){return this._opened?z`
            <ha-dialog        
                open
                hideActions
                @closed=${this.closeDialog}
                .heading=${bt(z`Select Blueprint
        ...
        `]}_itemClicked(t){_t(gt(`new/${t}`)),this.closeDialog()}connectedCallback(){super.connectedCallback(),this._updateBlueprints()}_updateBlueprints(){this.hass.callWS({type:ft("blueprints")}).then((t=>{this.blueprints=t.blueprints})).catch((t=>yt(this,{message:t.message})))}_listBlueprints(){if(!this.blueprints)return;let t={};for(let e of Object.values(this.blueprints))t[e.service]||(t[e.service]=[]),t[e.service].push(e);let e=[];for(let i in t){e.push(z`<h2>${i}</h2>`);for(let o of t[i])e.push(z`
                <mwc-list-item @click=${()=>this._itemClicked(o.id)} data-item-id="${o.id}">
                        <div class="row">
                            <div class="image">
                                ${o.has_image?z`<img src="${mt(`${o.id}.png`)}" />`:z`<ha-svg-icon style="fill: var(--primary-color);" .path=${ht}></ha-svg-icon>`}
                            </div>
                            <div class="name">${o.name}</div>
                        </div>
                </mwc-list-item>`)}return e}};t([o({attribute:!1})],Dt.prototype,"hass",void 0),t([o({attribute:!1})],Dt.prototype,"blueprints",void 0),t([s()],Dt.prototype,"_opened",void 0),Dt=t([e("switch-manager-dialog-blueprint-selector")],Dt);var Rt=Object.freeze({__proto__:null});let Vt=class extends rt{constructor(){super(...arguments),this._opened=!1}showDialog(t){this._opened=!0,this._error=null,this._params=t,this._newName=t.config.name}closeDialog(){this._params.onClose(),this._opened&&ut(this,"dialog-closed",{dialog:this.localName}),this._opened=!1}render(){return this._opened?z`
            <ha-dialog
                open
                scrimClickAction
                @closed=${this.closeDialog}
        ...
        `:z``}static get styles(){return[Ct,Et,p`
            ha-textfield,
            ha-textarea {
              display: block;
            }
          ...
          `]}_valueChanged(t){t.stopPropagation();const e=t.target;this._newName=e.value}_save(){this._newName?(this._params.update(Object.assign(Object.assign({},this._params.config),{name:this._newName})),this.closeDialog()):this._error="Name is required"}};t([o({attribute:!1})],Vt.prototype,"hass",void 0),t([s()],Vt.prototype,"_opened",void 0),t([s()],Vt.prototype,"_error",void 0),Vt=t([e("switch-manager-dialog-rename-switch")],Vt);var zt=Object.freeze({__proto__:null});
