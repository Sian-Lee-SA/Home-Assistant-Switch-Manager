    ...
    protected render(): TemplateResult 
    {
        ...
        return html`
            <ha-dialog
                ...
                ${this._blueprint!.service == 'Zigbee2MQTT' ? html`<ha-alert alert-type="warning">In Zigbee2MQTT ensure your device setting (specific) has legacy set to false/off (this setting is only visible for older devices)</ha-alert>`: ''}
